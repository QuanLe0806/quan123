    ...
    <div class="pafe-bottom__right">
        <div class="pafe-license">
            ...
            <?php if (!$has_key) {
                ...
                $active_url = PAFE_License_Service::HOMEPAGE_URL . "/dashboard/active/?p=pafepro&v=" . PAFE_PRO_VERSION ."&h={$home_url}&r={$redirect_url}";
            ?>
                <?php _e('Please activate your license to enable all features and receive new updates.','pafe'); ?>
                <br>
                <br>
                <a class="pafe-header__button pafe-header__button--gradient" href="<?php echo $active_url;?>" target="_blank"><?php _e('Active','pafe'); ?></a>
                <?php
            }
            ...
            if ($has_key) {
                ...
                $license_display_name = 'Piotnet Addons Pro';
