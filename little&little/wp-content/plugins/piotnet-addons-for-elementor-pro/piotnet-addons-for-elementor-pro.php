...
define( 'PAFE_PRO_VERSION', '6.5.18' );
...
final class Piotnet_Addons_For_Elementor_Pro {
	...
	public function pafe_pdf_metabox_output($post){
		...
		$html = '<div class="pafe-custom-font">
			...
			<button type="submit" id="pafe-pdf-upload-font" class="button">Upload/Add font</button>
			<button type="submit" id="pafe-pdf-remove-font" class="button">Remove font</button>
		</div>';
		echo $html;
	}
	...
	public function enqueue_scripts_widget() {
		...
		wp_register_script( 'pafe-widget-tel', plugin_dir_url( __FILE__ ) . 'assets/js/utils.js', array('jquery'), self::VERSION, false );
	}
    ...
    public function refresh_license() {
        PAFE_License_Service::refresh_license(true);
    }
